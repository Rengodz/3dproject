...
})({"Tt1jn":[function(require,module,exports) {
...
const sphereGeometry = new _three.SphereGeometry();
...
scene.add(sphere);
const particlesMesh = new _three.SphereGeometry(4, 10, 10);
const particlesMaterial = new _three.MeshBasicMaterial({
    color: 0x00FF88,
    wireframe: true
});
const particles = new _three.Mesh(particlesMesh, particlesMaterial);
...
},{"three":"ktPTu"}]},["Tt1jn","i3Wj0"], "i3Wj0", "parcelRequire9b6d")
